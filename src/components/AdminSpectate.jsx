...
export default function AdminSpectate() {
  ...
  if (!room) return (
    <div id="screen-spectate">
      ...
      <div className="status-bar"><div className="status-dot waiting" /><span>Loading...</span></div>
    </div>
  );
    ...
    <div id="screen-spectate">
      ...
      <div className="card">
        ...
        <div className="arena">
          <div className="arena-player">
            <div className={`arena-choice ${arenaChoices.c1 ? '' : ''}`}>
      ...
      <div className="card" style={{ marginTop: '1rem' }}>
        ...
        {historyRows.length === 0 ? (
          <div className="admin-empty" style={{ padding: '1rem' }}>No moves yet.</div>
        ) : (
